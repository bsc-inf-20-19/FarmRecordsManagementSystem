...
class DatabaseHelper {
 ...
 // Create a table for harvests
  ...
  insertCrop(Map<String, dynamic> cropData) {}

  static insertPlanting(Map<String, dynamic> plantingData) {}

  static getCrops() {}

  static getPlantings(DateTime selectedDate, {required DateTime endDate, required startDate}) {}

  static deletePlanting(int id) {}
}
