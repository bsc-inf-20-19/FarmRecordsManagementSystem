...
TextStyle pBold = TextStyle(
    fontSize: 18, fontWeight: FontWeight.w700, color: white);
TextStyle p1 =
    TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: text);
TextStyle p2 =
    TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: text);
TextStyle p3 =
    TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: text);

TextStyle pPrice = TextStyle(
    fontSize: 16, fontWeight: FontWeight.w600, color: white);

TextStyle pLocation = TextStyle(
